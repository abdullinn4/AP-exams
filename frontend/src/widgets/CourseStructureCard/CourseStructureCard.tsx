export const CourseStructureCard = () => {
    return (
        ...
        >
            <h2 className="display-5">Course Structure block</h2>
            <div className="mg-top-24px">
                <div className="w-layout-grid grid-1-column gap-row-24px">
                    ...
                    <div className="chapter-information-wrapper">
                        <img
                            src="/assets/webflow/images/lessons-icon-courselify-x-webflow-template.svg"
                            loading="eager"
                            alt="Lessons Icon"
                        />
                    ...
                    <div className="chapter-information-wrapper">
                        <img
                            ...
                            alt="Difficulty Icon"
                        />
                        <div>53 Lessons + Unit Reviews</div>
                    </div>
                    <div className="chapter-information-wrapper">
                        <img
