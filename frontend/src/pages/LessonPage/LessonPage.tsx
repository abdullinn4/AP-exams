...
export const LessonPage = () => {
    ...
    const {data: lesson, error} = useGetLessonDetailsQuery(
        {courseSlug: slug!, unitId: unitId!, lessonId: lessonId!},
    ...
    return (
        <div className="page-wrapper">
            ...
            {error ? (
                <div style={{textAlign: 'center', padding: '100px 0'}}>
                    <p style={{color: 'red'}}>Failed to load lesson details. Please try again later.</p>
                </div>
            ) : (
